...
//    String menuSender = "Sender";
//    String menuReceiver = "Receiver";
//    String menuLang = "Langauge";
    ...
    JMenuBar menuBar;
    JToolBar toolbar;
    JMenu fileMenu, senderMenu, receiverMenu, langMenu;
    JMenuItem menuSendMessage, menuClearMessage, englishLangButton, chineseLangButton;
    JButton toolSendBtn;
    ...
    public Chatroom(){
        ...
        englishLangButton = new JMenuItem("English");
        englishLangButton.addActionListener(this);
        chineseLangButton = new JMenuItem("Chinese");
        chineseLangButton.addActionListener(this);

        langMenu = new JMenu("Language ");
        menuBar.add(langMenu);
        langMenu.add(englishLangButton);
        langMenu.add(chineseLangButton);
    ...
    // Menu Items
        ...
        if(evt.getSource() == englishLangButton)
        {
            lang = "en";
            country = "US";
            Locale l = new Locale(lang, country);
            ResourceBundle r = ResourceBundle.getBundle("bundles", l);

            btnSendMessage.setText(r.getString("SEND"));
            toolSendBtn.setText(r.getString("SEND MESSAGE"));
            toolClearBtn.setText(r.getString("CLEAR MESSAGE"));
            ...
            toolChangeUser.setSelectedIndex(0);
            toolChangeUser.insertItemAt(r.getString("PICK SENDER"), 0);
            toolChangeUser.setSelectedIndex(0);
            toolChangeUser.removeItemAt(1);

            lblHistory.setText(r.getString("CHAT HISTORY"));
            lblMessage.setText(r.getString("MESSAGE LABEL"));

            fileMenu.setText(r.getString("FILE"));
            senderMenu.setText(r.getString("SENDER"));
            receiverMenu.setText(r.getString("RECEIVER"));
            langMenu.setText(r.getString("LANGUAGE"));

            menuSendMessage.setText(r.getString("SEND MESSAGE"));
            menuClearMessage.setText(r.getString("CLEAR MESSAGE"));
            englishLangButton.setText(r.getString("ENGLISH"));
            chineseLangButton.setText(r.getString("CHINESE"));

        }
        if(evt.getSource() == chineseLangButton){
